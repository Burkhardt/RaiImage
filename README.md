...
- Patch: aligns fallback package references with `OsLibCore 3.7.9` and `RaiUtils 3.7.9` in the current publish order.
...
- Refreshes current package docs and diagram release markers for the `3.7.9` line.
...
- Release notes: [RELEASE_NOTES_3.7.9.md](RELEASE_NOTES_3.7.9.md)
