...
- Patch: aligns fallback package references with `OsLibCore 3.7.8` and `RaiUtils 3.7.8` in the current publish order.
...
- Refreshes current package docs and diagram release markers for the `3.7.8` line.
...
- Release notes: [RELEASE_NOTES_3.7.7.md](RELEASE_NOTES_3.7.7.md) (3.7.8 is a version-symmetry patch without RaiImage feature changes)
