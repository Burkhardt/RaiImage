...
- Minor release: aligns fallback package references with `OsLibCore 3.10.0` and `RaiUtils 3.10.0`.
...
- Release notes: [RELEASE_NOTES_3.10.0.md](RELEASE_NOTES_3.10.0.md)
