...
- Fallback package references align to `OsLibCore 4.2.10` and `RaiUtils 4.2.10`; the RaiImage public API is unchanged from 4.2.9.
...
- The CR020/CR019/CR016 public API remains available on the coordinated v4.2.10 dependency line.
