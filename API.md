...
- RaiImage aligns with the `3.8.12` `RAIkeep` package line.
- Coordinated release: no RaiImage API changes from `3.8.11`; fallback package references align to `OsLibCore 3.8.12` and `RaiUtils 3.8.12`.
