...
## 3.11.5 release alignment

- Coordinated release: publishes RaiImage `3.11.5` with fallback dependencies aligned to the current `3.11.5` OsLib/RaiUtils package line.
...
- The aligned fallback dependencies remain `OsLibCore 3.11.5` and `RaiUtils 3.11.5` in the current package line.
