...
## 3.7.11 release alignment

- Patch: aligns RaiImage with the `3.7.11` `RAIkeep` package line in the current publish order.
...
- The aligned fallback dependencies remain `OsLibCore` and `RaiUtils` in the current package line.
