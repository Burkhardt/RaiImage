...
## 4.2.3 release alignment

- Coordinated release: prepares RaiImage `4.2.3` with fallback dependencies aligned to the current `4.2.3` OsLib/RaiUtils package line.
...
- The aligned fallback dependencies are `OsLibCore 4.2.3` and `RaiUtils 4.2.3` in the current package line.
