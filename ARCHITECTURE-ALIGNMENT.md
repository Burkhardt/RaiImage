...
- Coordinated release: aligns RaiImage with the `3.8.12` `RAIkeep` package line in the current dependency order.
...
- The aligned fallback dependencies remain `OsLibCore 3.8.12` and `RaiUtils 3.8.12` in the current package line.
