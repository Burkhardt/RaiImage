...
## 4.0.0 release alignment

- Coordinated release: publishes RaiImage `4.0.0` with fallback dependencies aligned to the current `4.0.0` OsLib/RaiUtils package line.
...
- The aligned fallback dependencies remain `OsLibCore 4.0.0` and `RaiUtils 4.0.0` in the current package line.
