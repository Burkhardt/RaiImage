# RaiImage 3.12.1 Release Notes

## Summary

- Releases `RaiImage` version `3.12.1`.
...
- Carries forward `PlantUmlCommand`, `PlantUml`, and `PlantUmlRenderResult` for CLI integration, including direct binary and `java -jar` execution paths, from `3.12.0`.
